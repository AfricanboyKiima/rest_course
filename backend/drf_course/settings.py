...
#SECRET_KEY = 'django-insecure-u)5(lgdx$z&c%dz6$by1iz0jr3piuwr8yut8@2ucbb5hgvte^4'
SECRET_KEY = os.environ.get("SECRET_KEY")#this code replaced the default values

# SECURITY WARNING: don't run with debug turned on in production!
#DEBUG = True
DEBUG = int(os.environ.get("DEBUG", default=0))#this code replaced the above code
